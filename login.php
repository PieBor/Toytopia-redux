                        ...
                        <div class="login_form inner_page style3 mb50">
                            <form action="loginHandler.php" method="post">
                                ...
                                <div class="form-group custom-control custom-checkbox">
                                    ...
                                    <a class="tdu btn-fpswd float-right" href="resetPassword.php">Forgot Password?</a>
                                </div>
                                <button type="submit" name="submit" class=" btn-log btn-block btn-thm2">Login</button>

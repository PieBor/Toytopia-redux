...
$maxAgeRangeLength = 60;
$ageRange = validateText($ageRange, $maxAgeRangeLength);
if ($ageRange[1] == "Success") {
    $ageRange = $ageRange[0];
} else
    echo $ageRange[1];

$sql = "SELECT ToyName, ToyImage, Description, Status, DateAddedToCollection, ToyConditionName, ToyBrandName
